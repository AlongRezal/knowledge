...
- [Angular](#angular)
    ...
    - [Mapping with Angular:](#mapping-with-angular)
...
Angular Console - The power of the Angular CLI. The convenience of an APP (Recently shifted to NX Monorepo oriented tool!)
